//
// This file was generated by Catalyst's C# compiler at 20/04/2025 17:42:21.
...
public record GetTaskResponse
{
    ...
    public required List<Lactose.Tasks.Dtos.ItemRewardDto> Rewards { get; set; }
...
{
    public required List<Lactose.Tasks.Dtos.GetTaskResponse> Tasks { get; set; }
...
public record CreateTaskRequest
{
    ...
    public required List<Lactose.Tasks.Dtos.TriggerDto> Triggers { get; set; }

    public List<Lactose.Tasks.Dtos.ItemRewardDto>? Rewards { get; set; }
...
public record UpdateTaskRequest
{
    ...
    public List<Lactose.Tasks.Dtos.TriggerDto>? Triggers { get; set; }
